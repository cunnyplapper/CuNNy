// CuNNy 4x4C BILINEAR RGB NVL DN
...
//!PASS 1
//!DESC CuNNy-4x4C-BILINEAR-RGB-NVL-DN-in
//!BLOCK_SIZE 8
//!NUM_THREADS 64
//!IN INPUT
//!OUT t0
...
#define l0(x, y) (dot(float3(2.428e-01, 4.714e-01, 1.229e-01), O(INPUT, float2(x, y)).rgb) + -7.696e-02)
